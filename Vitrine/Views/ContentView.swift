...
struct ContentView: View {
    ...
    private var canDecreaseCoverSize: Bool {
        coverSizeSteps.contains { $0 < coverWidth }
    }

    private var canIncreaseCoverSize: Bool {
        coverSizeSteps.contains { $0 > coverWidth }
    }
